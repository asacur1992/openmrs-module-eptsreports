...
=======
        "SELECT patient_id, NID,Name,birthdate,Estimated_dob,Sex,First_entry_date,Last_updated,date_enrolled,state,state_date,MIN(lab_form_date) AS lab_form_date,lab_form_date_created, location_name FROM("
