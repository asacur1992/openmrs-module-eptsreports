...
@Component
public class TxRttLessThan3MonthsListCalculator extends BaseFghCalculation {
  ...
  public DataSet evaluate(final EvaluationContext context) {
    ...
    final SimpleDataSet dataSet =
        new SimpleDataSet(this.txRTTCohortQueries.getTxRttLessThan3MonthsList(), context);
    ...
    final SqlQueryBuilder queryBuilder =
        new SqlQueryBuilder(
            EptsQuerysUtils.loadQuery(TxRttLessThan3MonthsListCalculator.TX_RTT_LIST),
