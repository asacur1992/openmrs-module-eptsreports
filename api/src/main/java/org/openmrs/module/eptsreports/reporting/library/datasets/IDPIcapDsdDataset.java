...
public class IDPIcapDsdDataset extends BaseDataSet {
  ...
  public DataSetDefinition constructTxNewDataset() {
    ...
    */
    ...
    final CohortIndicator patientOnIDPIndicator =
        this.eptsGeneralIndicator.getIndicator(
            "patientNewlyEnrolledInHIVIndicator", EptsReportUtils.map(patientOnIDP, mappings));
    ...
    */
    ...
    this.addColums(dataSetDefinition, "", patientOnIDPIndicator, UNKNOWN);
  ...
  private String getColumnName(final AgeRange range, final Gender gender) {
    return range.getDesagregationColumnName("P", gender);
  }
}
