...
public interface DSDQueriesInterface {
	class QUERY {
		...
		public static final String findPatientsWithAdverseDrugReactionsRequiringRegularMonitoringNotifiedInLast6Months = "Select p.patient_id From patient p "
		...
		public static final String findPatientsWhoHaveBeenNotifiedOfKaposiSarcoma = "SELECT p.patient_id FROM patient p "
				+ "inner join encounter e on p.patient_id=e.patient_id "
				+ "INNER JOIN obs o ON e.encounter_id = o.encounter_id "
		...
		public static final String findPatientsAreDefaultIIT = "Select IIT.patient_id from   ( "
		...
		public static final String findPatientsWhoAreFastTrack = "select ultima_consulta.patient_id "
				+ "from "
				+ "( "
		...
		public static String findPatientsWhoAreIncludedInDSDModel(
			...
			final String sql = "select patient_id "
					+ "from "
					+ "( "
					+ "	select * "
					+ "	from "
		...
		public static final String findPatientsWhoAreIncludedInDSDModel(
			...
			final String sql = "select ultima_ficha.patient_id "
					+ "from "
					+ "( "
					+ "	select p.patient_id,max(e.encounter_datetime) data_consulta "
					+ "	from patient p "
		...
		public static String findPatientsWhoArePregnantsAndBreastFeeding(final TypePTV typePTV) {
			...
			String query = "select patient_id from ( select inicio_real.patient_id,gravida_real.data_gravida, lactante_real.data_parto, "
		...
		public static final String findPatientsWhoAreOnARTForAtLeastSixMonths = "SELECT patient_id FROM "
		...
		public static final String findPatientsWhoIsBreastfeedingForAtLeast11Months = " select breastfeeding.patient_id from ( "
		...
		// TODO: Por rever
		public static final String findPatientsAgeRange = "SELECT patient_id FROM patient "
