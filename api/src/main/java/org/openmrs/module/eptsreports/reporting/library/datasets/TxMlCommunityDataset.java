...
public class TxMlCommunityDataset extends BaseDataSet {
  ...
  public DataSetDefinition constructtxMlDataset() {
    ...
    final CohortDefinition patientsWhoMissedNextApointment = null;

    final CohortDefinition ltfuLessThan3Months = null;

    final CohortDefinition ltfuLessGreatherThan3Months = null;
