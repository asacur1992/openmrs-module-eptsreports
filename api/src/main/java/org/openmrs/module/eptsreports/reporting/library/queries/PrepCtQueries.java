...
public interface PrepCtQueries {
	...
	class QUERY {
		...
		public static final String findClientsNewlyEnrolledInPrep = " select patient_id "
		...
		public static final String findClientsWhoWhereTransferredInBeforeReportingPeriod = " select patient_id "
		...
		public static final String findClientsWhoWhereTransferredInDuringReportingPeriod = " select patient_id "
				+ " from (	select minState.patient_id ,data_transferencia "
				+ " 		from	(	select client.patient_id, pg.patient_program_id, min(ps.start_date) as data_transferencia "
				+ " 				from patient client "
				+ " 		          	inner join patient_program pg on pg.patient_id = client.patient_id "
		...
		public static final String findClientsWhoReinitiatedPrep = "select patient_id from ( "
		...
		public static final String findClientsWhoContinuePrep = "select patient_id from ( "
		...
		public static final String findClientsWithPregnancyStatusDuringReportingPeriod = "select patient_id from( "
		...
		public static final String findClientsWithBreastfeedingStatusDuringReportingPeriod = "select patient_id from( "
				+ "select consulta.patient_id,gravida.data_gravida, lactante.data_lactante, "
				+ "            if(gravida.data_gravida is null and lactante.data_lactante is null,null, "
				+ "            if(gravida.data_gravida is null,2, "
				+ "            if(lactante.data_lactante is null,1, "
		...
		public static final String findClientsWithIndeterminateTestResult = "select prep.patient_id from ( "
		...
		public static final String findClientsWithNegativeTestResult = "select patient_id from ( "
		...
		public static final String findClientsWithPositiveTestResult = "select patient_id from ( "
		...
		public static final String findClientsWithAtLeastOneFollowUpVisitInFichaSeguimento = "select "
				+ "p.patient_id "
				+ "from patient p "
				+ "inner join encounter e on p.patient_id=e.patient_id "
				+ "where e.voided=0 "
		...
		public static final String findPrepCTByOralPrepType = "select prep.patient_id from "
				+ "( "
		...
		public static final String findPrepCTByInjectablePrepType = "select prep.patient_id from "
				+ "( "
				+ "select p.patient_id, max(e.encounter_datetime) data_consulta_oral "
				+ "		from patient p "
				+ "		inner join encounter e on e.patient_id=p.patient_id "
		...
		public static final String findPrepCTByOtherPrepType = "select prep.patient_id from "
				+ "( "
				+ "select p.patient_id, max(e.encounter_datetime) data_consulta_oral "
				+ "		from patient p "
				+ "		inner join encounter e on e.patient_id=p.patient_id "
		...
		public static String findClientsNewlyEnrolledInPrepBySubpopulation(final PrepNewKeyPopType keyPop) {
