...
import org.openmrs.module.eptsreports.reporting.library.cohorts.Eri2MonthsCommunityBMCohortQueries;
...
@Component
public class Eri2MonthsCommunityBMDataset extends BaseDataSet {

  @Autowired private EptsCommonDimension eptsCommonDimension;

  @Autowired private EptsGeneralIndicator eptsGeneralIndicator;

  @Autowired private Eri2MonthsCommunityBMCohortQueries eri2MonthsCohortQueries;
  ...
  public DataSetDefinition constructEri2MonthsDatset() {
    ...
    dsd.setName("ERI-2months-BM Data Set");
    ...
    this.addRow(
        ...
        EptsReportUtils.map(
            this.eptsGeneralIndicator.getIndicator(
                "All patients",
                EptsReportUtils.map(
                    this.eri2MonthsCohortQueries.getEri2MonthsTotalCompositionCohort(
                        "All Patients"),
                    mappings)),
            mappings),
