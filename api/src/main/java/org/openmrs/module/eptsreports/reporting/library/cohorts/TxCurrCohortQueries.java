...
public class TxCurrCohortQueries {
	...
	public CohortDefinition findPatientsWithLessThan200CD4WhoAreActiveOnARTTBLAM() {
		...
		definition.addSearch(
				...
				EptsReportUtils.map(
						this.genericCohorts.generalSql(
								"findCd4LessThan200",
								EptsQuerysUtils.loadQuery(TxCurrCohortQueries.FIND_PATIENTS_WITH_CD4_LESS_THAN_200)),
						mappings));
		...
		definition.addSearch(
				...
				EptsReportUtils.map(
						this.genericCohorts.generalSql(
								"findPatientTBLAM", EptsQuerysUtils.loadQuery(TxCurrCohortQueries.FIND_PATIENTS_TB_LAM)),
						mappings));
	...
	public CohortDefinition findPatientsWithLessThan200CD4OnARTANDGenExpert() {
		...
		definition.addSearch(
				...
				EptsReportUtils.map(
						this.genericCohorts.generalSql(
								"findPatientTBLAM", EptsQuerysUtils.loadQuery(TxCurrCohortQueries.FIND_PATIENTS_TB_GENEXPERT)),
						mappings));
	...
	public CohortDefinition findPatientsWithLessThan200CD4OnARTANDCrag() {
		...
		definition.addSearch(
				...
				EptsReportUtils.map(
						this.genericCohorts.generalSql(
								"findPatientTBLAM", EptsQuerysUtils.loadQuery(TxCurrCohortQueries.FIND_PATIENTS_TB_CRAG)),
						mappings));
	...
	public CohortDefinition findPatientsinDAHAndDiagnosticTB() {
		...
		definition.addSearch(
				...
				EptsReportUtils.map(
						this.genericCohorts.generalSql(
								"findPatientTBLAM", EptsQuerysUtils.loadQuery(TxCurrCohortQueries.FIND_PATIENTS_TB_DIAGNOSTIC)),
						mappings));
	...
	public CohortDefinition findPatientsinDAHAndDiagnosticTBTreatment() {
		...
		definition.addSearch(
				...
				EptsReportUtils.map(
						this.genericCohorts.generalSql(
								"findPatientTBLAM", EptsQuerysUtils.loadQuery(TxCurrCohortQueries.FIND_PATIENTS_TB_TREATMENT)),
						mappings));
	...
	public CohortDefinition findPatientsinDAHAndCragPositive() {
		...
		definition.addSearch(
				...
				EptsReportUtils.map(
						this.genericCohorts.generalSql(
								"findPatientTBLAM", EptsQuerysUtils.loadQuery(TxCurrCohortQueries.FIND_PATIENTS_CRAG_POSITIVE)),
						mappings));
	...
	public CohortDefinition findPatientsinDAHAndMCCDiagnostic() {
		...
		definition.addSearch(
				...
				EptsReportUtils.map(
						this.genericCohorts.generalSql(
								"findPatientTBLAM", EptsQuerysUtils.loadQuery(TxCurrCohortQueries.FIND_PATIENTS_MCC_DIAGNOSTIC)),
						mappings));
	...
	public CohortDefinition findPatientsinDAHAndMCCTreatment() {
		...
		definition.addSearch(
				...
				EptsReportUtils.map(
						this.genericCohorts.generalSql(
								"findPatientTBLAM", EptsQuerysUtils.loadQuery(TxCurrCohortQueries.FIND_PATIENTS_MCC_TREATMENT)),
						mappings));
