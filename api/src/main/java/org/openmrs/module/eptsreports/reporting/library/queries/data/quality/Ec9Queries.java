...
<<<<<<< HEAD
        "SELECT f_ec9.patient_id patient_id, "
            ...
            + "f_ec9.encounter_datetime encounter_datetime, "
            + "f_ec9.data_encounter_recepcao data_encounter_recepcao, "
            + "f_ec9.data_encounter_recepcao date_created, "
            ...
            + "and ( ( fila.encounter_datetime>abandoned.abandoned_date) OR (recepcao.encounter_datetime>abandoned.abandoned_date )) "
  ...
  public static String getEc9Total() {
    String query =
        "SELECT f_ec9.patient_id patient_id FROM ( "
            + "SELECT  abandoned.patient_id as patient_id, "
            + "pid.identifier AS NID, "
            + "concat(ifnull(pn.given_name,''),' ',ifnull(pn.middle_name,''),' ',ifnull(pn.family_name,'')) AS Name, "
            + "DATE_FORMAT(pe.birthdate, '%d-%m-%Y') AS birthdate, "
