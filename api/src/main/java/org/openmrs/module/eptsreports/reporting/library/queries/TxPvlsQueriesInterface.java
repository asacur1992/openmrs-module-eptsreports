    ...
    public static final String
        findPregnantWomanWhoHaveMoreThan3MonthsOnArtWithViralLoadRegisteredInTheLast12Months =
            "select patient_id from (select inicio_real.patient_id, inicio_real.data_inicio,carga_viral.data_carga,gravida_real.data_gravida,lactante_real.data_parto,if(gravida_real.data_gravida is null and lactante_real.data_parto is null,null,if(gravida_real.data_gravida is null,1,if(lactante_real.data_parto is null,2,if(max(lactante_real.data_parto)>max(gravida_real.data_gravida),1,2)))) decisao "
                ...
                + "inner join encounter e on p.patient_id=e.patient_id "
                + "inner join obs o on e.encounter_id=o.encounter_id "
                + "where p.voided=0 and e.voided=0 and o.voided=0 and o.concept_id=1465 and  e.encounter_type=6 and o.value_datetime between date_add(:endDate, interval -24 MONTH) and :endDate and e.location_id=:location) "
