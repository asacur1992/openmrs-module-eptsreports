...
public class OnArtInitiatedArvDrugsMisaDefinitionCalculation extends BaseFghCalculation {
	...
	public CalculationResultMap evaluate(
		...
		final Map<Integer, ? extends Object> processorResult = Context.getRegisteredComponents(OnArtInitiatedArvDrugsMISAUDefinitionProcessor.class)
				.get(0)
				.getResutls(context);
	...
	@Override
	public CalculationResultMap evaluate(
			final Collection<Integer> cohort, final Map<String, Object> parameterValues, final EvaluationContext context) {
