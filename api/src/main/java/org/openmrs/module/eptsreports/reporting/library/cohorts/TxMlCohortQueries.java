...
public class TxMlCohortQueries {
	...
	// a and b and died
	public CohortDefinition getPatientsWhoMissedNextAppointmentAndNotTransferredOutButDiedDuringReportingPeriod() {
		final CompositionCohortDefinition cd = new CompositionCohortDefinition();
		cd.setName(
	...
	public CohortDefinition getPatientsWhoMissedNextAppointmentAndNotTransferredOutAndNotConsentedDuringReportingPeriod() {
		final CompositionCohortDefinition cd = new CompositionCohortDefinition();
		cd.setName(
	 ...
	 */
	public CohortDefinition getPatientsWithVisitCardRegisteredBtwnLastAppointmentOrDrugPickupAndEnddate() {
		final SqlCohortDefinition sqlCohortDefinition = new SqlCohortDefinition();
	...
	public CohortDefinition getPatientsWhoMissedNextApointment() {
		final BaseFghCalculationCohortDefinition cd = new BaseFghCalculationCohortDefinition(
	...
	public CohortDefinition getPatientsWhoAreLTFUGreatherThan3MonthsCalculation() {
		...
		BaseFghCalculationCohortDefinition cd = new BaseFghCalculationCohortDefinition(
