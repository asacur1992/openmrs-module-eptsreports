  ...
  private void addSpecimenSentDisaggregation(
    ...
    final CohortIndicator specimentSent =
        this.eptsGeneralIndicator.getIndicator(
            "SPECIMEN-SENT",
            EptsReportUtils.map(
                this.txTbCohortQueries.getSpecimenSentCohortDefinition(Boolean.TRUE), mappings));
  ...
  private void addDiagnositcTestDisaggregation(
    ...
    final CohortIndicator geneExpert =
        this.eptsGeneralIndicator.getIndicator(
            ...
            EptsReportUtils.map(
                this.txTbCohortQueries.getGeneXpertMTBDiagnosticTestCohortDefinition(Boolean.TRUE),
                mappings));
  ...
  private void addPositiveResultsDisaggregation(
    ...
    final CohortIndicator positiveResults =
        this.eptsGeneralIndicator.getIndicator(
            "POSITIVE-RESULT",
            EptsReportUtils.map(
                this.txTbCohortQueries.getPositiveResultCohortDefinition(Boolean.TRUE), mappings));
