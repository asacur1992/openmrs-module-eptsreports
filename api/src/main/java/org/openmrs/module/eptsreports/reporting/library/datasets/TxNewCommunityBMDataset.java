...
@Component
public class TxNewCommunityBMDataset extends BaseDataSet {
  ...
  public DataSetDefinition constructTxNewDataset() {
    ...
    final CohortDefinition patientEnrolledInART =
        this.txNewCohortQueries.getTxNewCommunityBMCompositionCohort("patientEnrolledInART");
  ...
  private String getColumnName(final AgeRange range, final Gender gender) {
    return range.getDesagregationColumnName("NN", gender);
  }
}
