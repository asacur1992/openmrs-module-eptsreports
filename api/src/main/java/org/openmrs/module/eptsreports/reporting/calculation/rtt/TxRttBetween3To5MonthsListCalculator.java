...
@Component
public class TxRttBetween3To5MonthsListCalculator extends BaseFghCalculation {
  ...
  public DataSet evaluate(final EvaluationContext context) {
    ...
    final SimpleDataSet dataSet =
        new SimpleDataSet(this.txRTTCohortQueries.getTxRttBetween3To5MonthsList(), context);
